...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('speakers', postgresql.JSON(astext_type=sa.Text()), server_default='[]', nullable=True),
        sa.Column('default_unknown_speaker_label', sa.String(100), server_default='Guest', nullable=True),
        ...
        sa.Column('total_duration_seconds', sa.Integer(), server_default='0', nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('speakers', postgresql.ARRAY(sa.String()), server_default='{}', nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('completed_episodes', sa.Integer(), server_default='0', nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('permissions', postgresql.JSON(astext_type=sa.Text()), server_default='["read"]', nullable=True),
